;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="6f823b6b-5a2c-e839-6cb7-0668c8ecfc0b")}catch(e){}}();
    ...
    while(i < chunkModules.length){
        ...
        for(let j = i; j < end; j++){
            ...
            if (moduleFactories.has(id)) {
                ...
                console.log('[installCompressed] Skipping group, module already exists:', id);
                break;
            }
        }
        if (!hasExistingFactory) {
            ...
            for(; i < end; i++){
                ...
                console.log('[installCompressed] Installing factory for:', moduleId);
                moduleFactories.set(moduleId, moduleFactoryFn);
            }
        } else {
            console.log('[installCompressed] Preserved HMR factories for group:', groupIds.length, 'modules');
        }
...
/// <reference path="../../../shared/dev/dev-globals.d.ts" />
/// <reference path="../../../shared/dev/dev-protocol.d.ts" />
...
//# debugId=6f823b6b-5a2c-e839-6cb7-0668c8ecfc0b
