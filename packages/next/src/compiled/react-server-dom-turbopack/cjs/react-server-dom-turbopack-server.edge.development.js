...
function decodeReply(body, turbopackMap, options) {
  ...
  var response = createResponse(turbopackMap, '', options ? options.temporaryReferences : undefined, body, options ? options.arraySizeLimit : undefined);
...
function decodeReplyFromAsyncIterable(iterable, turbopackMap, options) {
  ...
  var response = createResponse(turbopackMap, '', options ? options.temporaryReferences : undefined, undefined, options ? options.arraySizeLimit : undefined);
  function progress(entry) {
    if (entry.done) {
      close(response);
    } else {
